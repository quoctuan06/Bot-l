...
url: (await global.nodemodule["axios"]('https://nguyenmanh.name.vn/api/world/vietnam ')).data.url,
method: "GET",
responseType: "stream"
})).data
...
module.exports.handleReply = async function({
  ...
  return api.sendMessage(`${res.data.answer}`, event.threadID, (err, data) => global.client.handleReply.push({
