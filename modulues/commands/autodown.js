const configCommand = {
	...
	toolsFb = {
		getVideoUrl: async (url) => {
			const res = await axios.get('https://api.sumiproject.net/facebook/video?url=' + encodeURIComponent(url));
...
async function noprefix(arg) {
	...
	const out = (a, b, c, d) => arg.api.sendMessage(a, b ? b : arg.event.threadID, c ? c : null, d ? d : arg.event.messageID),
		...
		regEx_facebook = /(^https:\/\/)(\w+\.)?(facebook|fb)\.(com|watch|reel|stories|post)\/\w+\/\w?(\/)?/,
