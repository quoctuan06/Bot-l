...
module.exports.run = async function ({ api, event, args, Users }) {
	...
	async function streamURL(url, mime = 'jpg') {
		const dest = `${__dirname}/cache/checktuongtac/${Date.now()}.${mime}`,
	...
	api.sendMessage({
		...
		attachment: [
			...
			await streamURL(`https://graph.facebook.com/${UID}/picture?height=720&width=720&access_token=6628568379%7Cc1e620fa708a1d5696fb991c1bde5662`)
		]
	}, threadID, (err, info) => {
...
/*module.exports.handleReply = async function ({ args, event, Users, api, handleReply, Currencies, handleReaction }) {
