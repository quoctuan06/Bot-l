...
const tho = (await axios.get(`https://nguyenmanh.name.vn/api/thathinh?type=girl`)).data.result.data
let attachment = []
  let length = [2,4,6];
...
url: (await global.nodemodule["axios"]('https://nguyenmanh.name.vn/api/world/vietnam')).data.result.data,
method: "GET",
responseType: "stream"
})).data
