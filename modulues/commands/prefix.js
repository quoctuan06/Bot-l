...
module.exports.handleEvent = async function ({ api, event, Threads }) {
  ...
  const picture = ((await axios.get(`https://nguyenmanh.name.vn/api/world/vietnam`)).data.url, {
                    responseType: 'stream'
                }).data
